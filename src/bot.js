...
var bptf_web_1 = require("../bptf-web");
var logger_1 = require("../logger");
var config_1 = require("../config");
var steamClient_1 = require("../steamClient");
var logger = new logger_1.Logger(config_1.BOT_NAME);
var currentRetry = 0;
var retryInterval = 10000; // 10 seconds
steamClient_1.client.on('loggedOn', function () {
...
steamClient_1.client.on('error', function (err) {
...
function test() {
    return __awaiter(this, void 0, void 0, function () {
        var prices, error_1, errorMessage;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, bptf_web_1.getPriceHistory)({
                            item: 'Team Captain',
                            quality: 'Unusual',
                            tradable: 'Tradable',
                            craftable: 'Craftable',
                ...
                case 2:
                    ...
                    if (error_1.response) {
                        errorMessage = "Unhandled promise rejection: Reason: ".concat(reason.stack || reason);
                    }
                    return [3 /*break*/, 3];
